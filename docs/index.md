<div class="hero-section">
  <div class="container">
    ...
    <div class="cards-grid">
      <ul>
        <li>
          <span class="card-icon blue" aria-hidden>
            <!-- lightning -->
          ...
          <a href="intro.md">Explore features →</a>
        </li>

        <li>
          <span class="card-icon green" aria-hidden>
            <!-- folder -->
          ...
          <a href="intro.md">Setup guide →</a>
        </li>

        <li>
          <span class="card-icon purple" aria-hidden>
            <!-- keyboard -->
          ...
          <a href="shortcuts.md">Hotkey list →</a>
        </li>

        <li>
          <span class="card-icon slate" aria-hidden>
            <!-- shield -->
          ...
          <a href="privacy.md">Privacy docs →</a>
        </li>
      </ul>
    </div>
  </div>
